...
python Tools/docgen/docgen.py -r GameState UiKeyboardListener FadeInBehaviour PauseMenuBehaviour SceneLoaderBehaviour CameraManipulatorBehaviour -d | dot -Tsvg -o Assets/Scripts/Systems/GameStateSystem/GameState.svg
